...
MY_VALIDATOR_ADDRESS=$(socialvd keys show dev0 -a)
```
...
yes $KEYPASSWD | socialvd keys add me
yes $KEYPASSWD | socialvd keys show me
# start socialvd with keyring-backend flag
socialvd --keyring-backend=file start
```
